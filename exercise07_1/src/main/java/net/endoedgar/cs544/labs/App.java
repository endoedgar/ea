...
import net.endoedgar.cs544.labs.model.Airline;
import net.endoedgar.cs544.labs.model.Airplane;
import net.endoedgar.cs544.labs.model.Airport;
import net.endoedgar.cs544.labs.model.Flight;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Flight> flights = session.createQuery("from Flight f WHERE f.airplane.capacity > 500").list();
        ...
        try {
            ...
            @SuppressWarnings("unchecked")
            List<Airline> airlines = session.createQuery("SELECT distinct al from Airline al JOIN al.flights f JOIN f.airplane a WHERE a.model <> 'A380'").list();
