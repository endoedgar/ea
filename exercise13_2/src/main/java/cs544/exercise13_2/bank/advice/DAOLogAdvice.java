...
public class DAOLogAdvice {
    ...
    @Before("execution(* cs544.exercise13_2.bank.dao.IAccountDAO.*(cs544.exercise13_2.bank.domain.Account)) && args(account)")
    ...
    @Before("execution(* cs544.exercise13_2.bank.dao.IAccountDAO.*(long)) && args(accountnumber)")
