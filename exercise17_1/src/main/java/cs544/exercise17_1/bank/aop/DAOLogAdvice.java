...
public class DAOLogAdvice {
    ...
    @Before("execution(* cs544.exercise17_1.bank.dao.IAccountDAO.*(cs544.exercise17_1.bank.domain.Account)) && args(account)")
    ...
    @Before("execution(* cs544.exercise17_1.bank.dao.IAccountDAO.*(long)) && args(accountnumber)")
